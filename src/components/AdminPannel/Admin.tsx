...
const AdminPanel = () => {
  const [selectedModel, setSelectedModel] = useState<string>('users') // Default model is 'users'
  ...
  if (loading) {
    return <div className='flex justify-center items-center h-screen'><LoaderCircle/>
</div>
  }
